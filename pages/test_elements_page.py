...
class Elementspage():
    ...
    def __init__(self, driver):
        ...
        self.menu_check_box_path = (By.XPATH, "//span[text()='Text Box']")
    ...
    def is_check_box_path_visible(self):
        return self.driver.find_element(*self.menu_check_box_path).is_displayed()